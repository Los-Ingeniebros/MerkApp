  ...
  return (
    <div className="">
      <div className="container">
        <div className="form">
          <span className="log">Registro</span>
          <form onSubmit={submitHandler}>
            <div>
              ...
              />
              {advertencias.nombre && (
                <p className="advertencia">{advertencias.nombre}</p>
              )}
            </div>
            <div>
              ...
              />
              {advertencias.apellido && (
                <small className="advertencia">{advertencias.apellido}</small>
              )}
            </div>
            ...
            <div>
              ...
              {advertencias.rol && (
                <p className="advertencia">{advertencias.rol}</p>
              )}
            </div>
            <div>
              ...
              />
              {advertencias.numero && (
                <p className="advertencia">{advertencias.numero}</p>
              )}
            </div>
            <div>
              ...
              />
              {advertencias.correo && (
                <p className="advertencia">{advertencias.correo}</p>
              )}
            </div>
            <div>
              ...
              />
              {advertencias.contrasenia && (
                <p className="advertencia">{advertencias.contrasenia}</p>
              )}
            </div>
            <div className="boton">
              <button type="submit" id="submit" className="boton-animado">
                Registrar
              </button>
            </div>
          </form>
